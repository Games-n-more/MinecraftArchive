...
public class M extends Applet implements Runnable {
   ...
   public void run() {
      try {
         ...
         for(int var6 = 1; var6 < 16; ++var6) {
            ...
            for(int var8 = 0; var8 < 48; ++var8) {
               for(int var9 = 0; var9 < 16; ++var9) {
                  ...
                  var12 = (var10 >> 16 & 255) * var11 / 255 << 16 | (var10 >> 8 & 255) * var11 / 255 << 8 | (var10 & 255) * var11 / 255;
                  var57[var9 + var8 * 16 + var6 * 256 * 3] = var12;
               }
            }
         }
         ...
         while(true) {
            float var18 = (float)Math.sin((double)var16);
            float var19 = (float)Math.cos((double)var16);
            float var20 = (float)Math.sin((double)var17);
            float var21 = (float)Math.cos((double)var17);

            float var26;
            int var70;
            while(System.currentTimeMillis() - var63 > 10L) {
               float var22;
               float var23;
               if (this.M[2] > 0) {
                  var22 = (float)(this.M[2] - 428) / 214.0F * 2.0F;
                  var23 = (float)(this.M[3] - 240) / 120.0F * 2.0F;
                  float var24 = (float)Math.sqrt((double)(var22 * var22 + var23 * var23)) - 1.2F;
                  if (var24 < 0.0F) {
                     var24 = 0.0F;
                  }
               ...
               var22 = 0.0F;
               var23 = 0.0F;
               var23 += (float)(this.M[119] - this.M[115]) * 0.02F;
               var22 += (float)(this.M[100] - this.M[97]) * 0.02F;
               var61 *= 0.5F;
               var62 *= 0.99F;
               var64 *= 0.5F;
               var61 += var18 * var23 + var19 * var22;
               var64 += var19 * var23 - var18 * var22;
               var62 += 0.003F;

               label265:
               for(var70 = 0; var70 < 3; ++var70) {
                  float var25 = var58 + var61 * (float)((var70 + 0) % 3 / 2);
                  var26 = var60 + var62 * (float)((var70 + 1) % 3 / 2);
                  float var27 = var59 + var64 * (float)((var70 + 2) % 3 / 2);
            ...
            for(var70 = 0; var70 < 12; ++var70) {
               var71 = (int)(var58 + (float)(var70 >> 0 & 1) * 0.6F - 0.3F) - 64;
               int var72 = (int)(var60 + (float)((var70 >> 2) - 1) * 0.8F + 0.65F) - 64;
               var73 = (int)(var59 + (float)(var70 >> 1 & 1) * 0.6F - 0.3F) - 64;
               if (var71 >= 0 && var72 >= 0 && var73 >= 0 && var71 < 64 && var72 < 64 && var73 < 64) {
                  var4[var71 + var72 * 64 + var73 * 4096] = 0;
               }
            }
            ...
            for(var71 = 0; var71 < 214; ++var71) {
               ...
               for(var73 = 0; var73 < 120; ++var73) {
                  ...
                  float var75 = 1.0F;
                  float var76 = var75 * var21 + var74 * var20;
                  float var77 = var74 * var21 - var75 * var20;
                  float var32 = var26 * var19 + var76 * var18;
                  float var33 = var76 * var19 - var26 * var18;
                  int var34 = 0;
                  int var35 = 255;
                  double var36 = 20.0D;
                  float var38 = 5.0F;
                  ...
                  for(var39 = 0; var39 < 3; ++var39) {
                     ...
                     float var45 = var58 - (float)((int)var58);
                     if (var39 == 1) {
                        var45 = var60 - (float)((int)var60);
                     }

                     if (var39 == 2) {
                        var45 = var59 - (float)((int)var59);
                     }
                     ...
                     float var48 = var60 + var43 * var45;
                     float var49 = var59 + var44 * var45;
                     if (var40 < 0.0F) {
                        if (var39 == 0) {
                           --var47;
                        }
                     ...
                     while((double)var46 < var36) {
                        ...
                        if (var54 > 0) {
                           ...
                           if (var53 != var14 || var67 > 0 && var69 % 16 > 0 && var67 < 15 && var69 % 16 < 15) {
                              var55 = var57[var67 + var69 * 16 + var54 * 256 * 3];
                           }
                  ...
                  var3[var71 + var73 * 214] = var39 << 16 | var78 << 8 | var79;
               }
            }
            ...
            this.getGraphics().drawImage(var2, 0, 0, 856, 480, (ImageObserver)null);
         }
